module.exports = {
    ...
    async afterFindOne(event) {
        ...
        const supportedIdPrefixes = (value) => ({
            ...
            "http://rpb.lobid.org/sw/": { url: `https://rpb-cms.lobid.org/api/rpb-authorities?pagination[limit]=1&filters[rpbId][$eq]=${lastSegment(value)}`, test: (r) => r.data.length > 0, process: (r) => r.data[0].attributes.f3na },
